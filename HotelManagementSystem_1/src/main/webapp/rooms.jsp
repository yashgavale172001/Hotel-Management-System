...
<head>
    ...
    <style>
        /* Overall page styling with a more attractive background */
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="sort-container">
        <h2>Sort Rooms</h2>
        <form action="sortRooms" method="get" class="sort-form">
    ...
    <%
       ...
       // List<Rooms> sortRooms=(List<Rooms>)hs.getAttribute("sortRoom");
